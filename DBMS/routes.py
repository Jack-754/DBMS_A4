...
from DBMS import app, db, bcrypt, mail
from DBMS.forms import RestaurantRegistrationForm, UserRegistrationForm, LoginForm, UpdateForm, AddDishForm, ForgotPasswordForm, ResetPasswordForm, DonationForm,TimeForm,CartForm
